...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = {
    ...
    {KC_NO,   KC_NO,   KC_NO,   KC_LALT, KC_FN0,  KC_LCTL, KC_SPC,  KC_FN1,  KC_RGUI, KC_NO,    KC_NO,   KC_NO},
  },
  [1] = {
    {KC_TRNS,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,     KC_0,   KC_TRNS},
    {KC_TRNS, KC_FN11, KC_QUOT, KC_LBRC, KC_FN12, KC_FN13, KC_FN14, KC_FN15, KC_FN17, KC_MINS,  KC_FN16, KC_PAUS},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_LALT, KC_FN0,  KC_LCTL, KC_SPC,  KC_FN1,  KC_RGUI, KC_TRNS, KC_TRNS,  KC_TRNS},
  },
  [2] = {
    {KC_GRV,  KC_TRNS, KC_FN21, KC_FN22, KC_FN24, KC_TRNS, KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC,  KC_BSLS, KC_TRNS},
    {KC_TRNS, KC_FN20, KC_FN25, KC_FN23, KC_FN27, KC_FN26, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_EQL,  KC_NO},
    {KC_TRNS, KC_MUTE, KC_F20,  KC_TRNS, KC_TRNS, KC_PSCR, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS},
    {KC_TRNS, KC_TRNS, KC_TRNS, KC_LALT, KC_FN0,  KC_LCTL, KC_SPC,  KC_FN1,  KC_RGUI, KC_TRNS, KC_TRNS,  KC_TRNS},
  },
};
...
const action_t PROGMEM fn_actions[] = {
    ...
    /* [9] = ACTION_MODS_TAP_KEY(KC_RSFT, KC_CAPS), */
